...
const cloudinaryAPI = '611346773349953';
const uploadPreset =  'dowzkkkon';
...
export default function UploadImage({ handelFileUpload }) {
    ...
    return (
        <div div className="cursor-pointer w-full py-2 px-4 text-sm font-bold hover:bg-green-500 hover:text-primary-50" >
