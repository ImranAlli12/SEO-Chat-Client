...
export default function CreateGroupChat() {
    ...
    return (
        <section>
            <button
                onClick={toggleModal}
                className="flex border-2 border-primary-400 items-center gap-2 text-white bg-green-500 hover:bg-green-600 focus:ring-4 focus:outline-none focus:ring-yellow-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center "
                type="button"
            >
                    ...
                    <div className="bg-white rounded-lg shadow p-6 max-w-md w-full">
                        <div className="text-left">
                            ...
                            {!isSearchUserProcessing && searchedUser.length === 0 && (
                                <p className="text-gray-700 text-center mt-4">No User Found.</p>
                            )}
                            ...
                            <div className='float-right' >
                                ...
                                <button
                                    ...
                                    className="text-gray-800 mr-3  bg-white hover:bg-yellow-200 focus:ring-4 focus:outline-none focus:ring-gray-200 rounded-lg border border-gray-800 text-sm font-medium px-5 py-2.5  focus:z-10 "
                                >
                                    Cancel
                                </button>
                                ...
                                <button
                                    ...
                                    type="button"
                                    disabled={createGroupChatProcessing}
                                    className="text-white mt-5 bg-green-500 hover:bg-green-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center"
                                >
