...
export default function AddMembers() {
    ...
    return (
        <section>
            ...
            <button className="cursor-pointer w-full py-2 px-4 text-sm font-bold hover:bg-green-700 hover:text-primary-50" onClick={toggleModal}>
                Add members
            </button>
                    ...
                    <div className="bg-primary-50 text-primary-800 rounded-lg p-4">
                        ...
                        <div className='float-right' >
                            ...
                            <button
                                ...
                                className="text-gray-800 mr-3  bg-green-400 hover:bg-yellow-400 focus:ring-4 focus:outline-none focus:ring-gray-200 rounded-lg border border-gray-800 text-sm font-medium px-5 py-2.5  focus:z-10 dark:bg-green-200 dark:text-gray-600 dark:border-yellow-500 dark:hover:text-white dark:hover:bg-green-300 dark:focus:ring-yellow-500"
                            >
                                Cancel
                            </button>
                            ...
                            <button
                                ...
                                type="button"
                                disabled={addMembersInGroupProcessing}
                                className="text-white mt-5 bg-green-500 hover:bg-green-700 focus:ring-4 focus:outline-none focus:ring-yellow-400 dark:focus:ring-yellow-600 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center"
                            >
