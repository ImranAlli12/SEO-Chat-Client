...
export default function RenameGroup() {
    ...
    return (
        <section>
            ...
            <button className="cursor-pointer w-full py-2 px-4 text-sm font-bold hover:bg-green-500 hover:text-primary-50" onClick={toggleModal}>
                Change Name
            </button>
            ...
            {showModal && (
                <div className="fixed top-0 left-0 right-0 bottom-0 flex items-center justify-center z-50 backdrop-filter backdrop-blur-sm">
                    <div className="bg-primary-50 text-primary-800 rounded-lg p-4">
                        ...
                        <input
                            className="w-full bg-primary-50 border border-yellow-500 text-primary-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 p-2.5 dark:bg-green-200 dark:border-yellow-600 dark:placeholder-primary-500  dark:focus:ring-yellow-800 dark:focus:border-yellow-500"
                            type="text"
                            value={groupName}
                        ...
                        {/* submit button */}
                        <button
                            className={`bg-green-500 float-right mt-5 hover:bg-green-700 text-primary-50 rounded-md py-1 px-4  ${isRenameGroupProcessing ? 'opacity-50 cursor-not-allowed' : ""}`}
