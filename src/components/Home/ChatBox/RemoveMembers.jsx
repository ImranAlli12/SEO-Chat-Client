        ...
        <div>
            ...
            {showModal && (
                <div className="fixed top-0 left-0 right-0 bottom-0 flex items-center justify-center z-50 backdrop-filter backdrop-blur-sm">
                    <div className="bg-primary-50 text-green-800 rounded-lg p-4 max-w-md w-full">
                        <div className="flex justify-between items-center mb-5">
                            <h2 className="text-lg font-bold"> Remove members from group </h2>
                            <button className="hover:text-yellow-600 text-yellow-500 rounded-md py-1 px-2" onClick={toggleModal}>
                    ...
                    {/* removing button */}
                    <button
                        className={`bg-green-500 float-right mt-5 hover:bg-green-700 text-primary-50 rounded-md py-1 px-4  ${removeMembersFromGroupProcessing ? 'opacity-50 cursor-not-allowed' : ""}`}
